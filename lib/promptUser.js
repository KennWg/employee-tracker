...
//Get budget
const getBudgetPrompt = () => {
    inquirer.prompt([
        {
            type: 'number',
            name: 'id',
            message: 'Please enter the ID of the department you wish to check the budget of.',
            validate: input => {
                if (input) {
                    return true;
                } else {
    ...
    ]).then(answer => dbFunctions.getBudget(answer))
};
    ...
    inquirer.prompt([
        {
            ...
            choices: ['View all departments', 'View all roles', 'View all employees', 'View employees by manager', 'View employees by department', 'Add a department', 'Add a role', 'Add an employee', 'Update an employee role', 'Update an employee manager', 'Delete a department', 'Delete a role', 'Delete an employee', 'Get department budget']
        }
    ]).then(answer => {
